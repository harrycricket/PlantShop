...
public class CookieFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //do cookie filter
        System.out.println("DOING COOKIE FILTER");
        ...
        if (!logined && cookies != null) {
            ...
            if (!"".equals(token)) {
                Account loginedAccount = AccountDAO.getAccountByToken(token);

                if (loginedAccount != null) {
                    session = httpRequest.getSession(true);
                    session.setAttribute("loginedUser", loginedAccount);
                }
            }
        }
